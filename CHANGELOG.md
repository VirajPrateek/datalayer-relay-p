...
| **v2.5.4** | `feat/event-allowlist` | Unified "not allowed" events into "blocked" stats| **Prod** | ✅ Stable |
| **v2.5.3** | `feat/event-allowlist` | Added event prefix allowlist and toggle.| **Local** | ⏩ Superseded |
| **v2.5.2** | `main` | Added `idleCallback` with `setTimeout` fallback. | **QA2** | ✅ Stable |
